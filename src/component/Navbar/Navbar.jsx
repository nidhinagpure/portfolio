  ...
  return (
    <div className='navbar'>
        ...
        <ul className='nav-menu'>
            <li><AnchorLink className='a-link' offset={50} href='#home'><p onClick={()=>setmenu("home")}>Home</p>{menu==="home"?<img src={Underline} alt="" style={{height:"10px"}}/>:<></>}</AnchorLink></li>
            <li><AnchorLink className='a-link'  offset={50}  href='#about' ><p onClick={()=>setmenu("about")}>About Me</p>{menu==="about"?<img src={Underline} alt="" style={{height:"10px"}}/>:<></>}</AnchorLink></li>
